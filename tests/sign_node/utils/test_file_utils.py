...
class TestFileUtils(TestCase):
    ...
    def test_chown_recursive(self):
        with patch('sign_node.utils.file_utils.plumbum') as plumbum:
            chown = Mock()
            plumbum.local = {
                'sudo': {
    ...
    def test_http_download(self):
        ...
        with patch('sign_node.utils.file_utils.pycurl.Curl', return_value=curl):
    ...
    def test_ftp_download(self):
        ...
        with patch('sign_node.utils.file_utils.ftplib.FTP'):
