...
class RetryParamikoMachine(ParamikoMachine):
    ...
    def __init__(self, host, **kwargs):
        ...
        self.host, self._retry_kwargs = self._load_system_ssh_config(host, kwargs)
        ...
        retry_init = self.retry_request_wrapper(self._retry_init, only_connect=True)
        retry_init()
    ...
    def _retry_init(self):
        ...
        """
        super(RetryParamikoMachine, self).__init__(self.host, **self._retry_kwargs)
