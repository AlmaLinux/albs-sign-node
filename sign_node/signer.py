...
from common_library.constants import COMMUNITY_KEY_SUFFIX
from common_library.signer.base_signer import BaseSigner
...
class Signer(BaseSigner):
    ...
    def _request_sign_task(self) -> typing.Dict:
        ...
        """
        pgp_keyids = list(self._password_db.key_ids.keys())
